...
;insert模式
    ...
    ; vim.Map("<f1>", "<GoogleChrome_新建>", "GoogleChrome")
    ; vim.Map("<f2>", "<GoogleChrome_左标签>", "GoogleChrome")
    ; vim.Map("<f3>", "<GoogleChrome_右标签>", "GoogleChrome")
    ; vim.Map("<f4>", "<GoogleChrome_关闭>", "GoogleChrome") 
